...
Self-contained programs, each compilable against `../include` plus the
submodule include directories (or the single header). Build with
`make`, build and run with `make run`; they also build and run as
tests through CMake/CTest.
